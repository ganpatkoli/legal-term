        ...
        <header className="header-area style-5">
          <div className="nav-left">
            <div className="header-logo">
              <a href="index.html">
                <img alt="image" src="/src/assets/images/logos/field_logo.png" />
              </a>
            </div>
        ...
        <div className="banner-section3">
          ...
          <div className="container-fluid">
            <div className="row">
              ...
              <Swiper pagination={true} parallax={true} effect="fade" modules={[Autoplay]}
                className="mySwiper"
                // spaceBetween={25}
                slidesPerView={1}
          ...
          <div className="container">
            <div className="row justify-content-center g-4">
              <div className="col-12">
                <Swiper pagination={true} parallax={true} effect="fade" autoplay={{ delay: 2000 }} modules={[Autoplay]}
                  className="mySwiper"
                  spaceBetween={25}
                  slidesPerView={3}
                // pagination={{ clickable: true }}
